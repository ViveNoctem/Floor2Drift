...
- order by
- group by? (does floor support that?)
...
- default value
    - it doesn't work with type converters/enums
        - because drift wants a SQL type default and floor wants a converted type default
...
- rename field names
  ...
  - Add to the [configuration](#configuration) section
